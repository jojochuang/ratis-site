...
const sidebars: SidebarsConfig = {
  tutorialSidebar: [
    ...
    },
    {
      ...
      items: [
        'developer-guide/streaming-configuration',
        'developer-guide/statemachine-developer-guide',
        'developer-guide/statemachine-core-api',
        'developer-guide/listeners',
        'developer-guide/linearizable-read',
        'developer-guide/security',
        'developer-guide/watch-requests',
        'developer-guide/group-management',
        'developer-guide/snapshot-management-api',
        'developer-guide/membership-change',
      ],
    },
    {
      type: 'category',
